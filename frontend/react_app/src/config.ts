...
const config = {
  ...
  API_BASE_URL: process.env.REACT_APP_API_URL || 'https://specter-vwjk.onrender.com',

  // For translation service (if needed)
  TRANSLATE_API_URL: process.env.REACT_APP_TRANSLATE_URL || 'https://specter-vwjk.onrender.com',
};
